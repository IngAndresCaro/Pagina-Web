...
<html>
  ...
  <body>
    ...
    <div class="contenedor">
      ...
      <?php //Nuestras variables de ingreso de html que llega con name ?>
      <?php $resultado = $_POST;?>
      ...
      <?php
          //================================================================================ validar  un Checkboxe
      //validar checkboxes (singular) ?>
      <?php
      ...
      <?php if(isset($_POST['mensaje'])) {
        ...
        $nuevo_mensaje = filter_var($mensaje, FILTER_SANITIZE_STRING);//Forma en la cual se puede limpiar el codigo para que no venga infectado
